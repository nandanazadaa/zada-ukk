                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="<?= base_url('Auth/admin_register'); ?>">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <button type="submit" class="btn btn-block" style="background-color: #93764D; color:white;">Simpan
                                                </button>
                                        </div>
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="<?= base_url('Auth/admin_login') ?>">Sudah memiliki Akun?.Silahkan login !</a></div>
                                </div>
